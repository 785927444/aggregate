    ...
    <div class="layout-col white">
      ...
      <div class="ww100 flex-bc mb12">
        ...
        <div class="flex-ec flex1">
          <div class="rad4 ptb8 plr12 flex-cc cursor bgi1 white ml10" @click.stop="handleClick('submit')">
            <i-ep-pointer class="f12 fw" /><span class="f14 ml5">保存</span>
          </div>
          <div class="rad4 ptb8 plr12 flex-cc cursor bgi1 white ml10" @click.stop="handleClick('setlist')" v-if="configStore.user&&configStore.user.role_id=='1'">
            <i-ep-plus class="f12 fw" /><span class="f14 ml5">生成配置</span>
          </div> 
          <div class="rad4 ptb8 plr12 flex-cc cursor bgi1 white ml10" @click.stop="handleClick('reset')">
        ...
        <el-descriptions :column="1" size="large" border>
          ...
          <el-descriptions-item label="手动对时">
            <div class="flex-sc hh100">
              ...
              <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white w90 hh100 ml10" @click.stop="handleClick('settime')">
          ...
          <el-descriptions-item label="重启服务">
            <div class="flex-sc hh100">
              <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white hh100 w90" @click.stop="handleClick('restart')">
          ...
          <el-descriptions-item label="备份数据">
            <div class="flex-sc hh100">
              <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white hh100 w90" @click.stop="handleClick('backup')">
