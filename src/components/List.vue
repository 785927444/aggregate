<template>
    <div class="layout-col">
      ...
      <div class="table bg-white">
        <div class="row cursor" :class="publicStore.active[state.key] == item[state.key]?'active':index%2 == 1?'i2':'i2'" v-for="(item, index) in state.list" :key="index" @click.stop="emit('handleClick', 'active', item)">
