...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'w50x3', show: true, align: 'left', key: 'bayNum', name: '区域', type: 'select', list: [], value: 'id', label: 'station_name' },
      { width: 'w50x3', show: true, align: 'left', key: 'gateway_id', name: '网关机', type: 'select', list: [], value: 'id', label: 'machine_name' },
