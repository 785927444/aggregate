<template>
    <div class="layout-col">
        <div class="ww100 flex-sc pr15 i15 mb10">  
            ...
            <el-button class="rad4 ptb5 plr8 flex-cc cursor bgi1 white ml10" @click.stop="handleClick('controls')">批量控制</el-button>
        </div>
        <!-- 内容 -->
            ...
            state.active=='All'&&state.bay=='All'&&!state.airName?publicStore._public.homeDevices : [] : []" :key="i">
                <div class="ww100 flex-col rad6 i15 bs2">
                    ...
                    <div class="flex1 flex-cc pb12">
                        ...
                        <div class="flex1 flex-cc">
                            <div class="flex-sc bgi1 white rad3 cursor ptb5 pl5 pr12" @click.stop="logRef.onVisable(v)">
                        ...
                        <div class="flex1 flex-cc">
                            <div class="flex-sc bgi1 white rad3 cursor ptb5 pl5 pr12"  @click.stop="publicStore._public.init = !publicStore._public.init; ctrlRef.onVisable(v)">
