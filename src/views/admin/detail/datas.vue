<template>
  <div class="layout-col">
    <!-- 标题 -->
		<aa-title title="设备选择"><template #right-content></template></aa-title>
    <!-- 内容 -->
    <div v-if="isNull(state.tree)" class="layout-col hh100 bg-white rad8">
    ...
    <div v-if="!isNull(state.tree)" class="table-col bg-white rad8">
      <el-tree 
      class="ww100" 
      ref="treeRef" 
      :data="state.tree"
