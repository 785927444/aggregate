  ...
  <div class="relative ww100 flex-sc white-rgba40">
    ...
    <div class="absolute-cc tc ww100 flex-bc plr15">
      ...
      <div class="hh100 flex1 flex-ec i2">
        ...
        <div class="flex-sc cursor relative ml20" @click="setRef.onVisable()" v-if="configStore.user&&(configStore.user.role_id=='1'||configStore.user.role_id=='2')">
          <i-ep-tools class="f20 c8" />
        </div>
